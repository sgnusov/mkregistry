                                ...
                                <li class="list-group-item p-3">
                                    <form action="/" method="post">
                                        ...
                                        <div class="form-group">
                                            <label>File</label>
                                            <input name="mark" type="number" min="1" max="100" class="form-control" placeholder="Ваша оценка" aria-label="Ваша оценка" aria-describedby="basic-addon1">
                                        </div>
                                        <div class="row">
                                            <div class="col">
                                                <button type="submit" class="mb-2 btn btn-outline-danger mr-2 btn-lg" style="">Оценить</button>
                                            </div>
                                        </div>
                                    </form>
                                    <form method ='get'>
        ...
        <div class="my-4 mx-auto border-left">
            <main class="main-content ">
                <div class="main-content-container container-fluid text-center">
                    <div class="page-header row no-gutters py-4 mb-3 text-center">
                        <div class="col-12 text-center">
                            <h5 class="page-title align-items-center">Вам не разрешено оценивать файлы</h5>
                        </div>
                    </div>
                </div>
            </main>
