        ...
        <div class="main-content-container container-fluid text-center">
            <div class="page-header row no-gutters py-4 mb-3 text-center">
                <div class="col-12 text-center">
                    <h5 class="page-title align-items-center">Добавьте решение</h5>
                </div>
            </div>
            <div class="row">
                                ...
                                <li class="list-group-item p-3">
                                    <form action="/" method="post">
                                        ...
                                        <div class="form-group">
                                            <label>${x}</label>
                                            <input name="name" type="text" class="form-control" placeholder="Ваше имя" aria-label="Ваше имя" aria-describedby="basic-addon1">
                                        </div>
                                        <div class="form-group">
                                            <textarea name="desc" type="text" class="form-control" placeholder="Решение" aria-label="Решение" aria-describedby="basic-addon1"></textarea>
                                        </div>
                                        <div class="row">
                                            <div class="col">
        ...
        <div class="my-4 mx-auto border-left">
            <main class="main-content ">
                <div class="main-content-container container-fluid text-center">
                    <div class="page-header row no-gutters py-4 mb-3 text-center">
                        <div class="col-12 text-center">
                            <h5 class="page-title align-items-center">Вам не разрешено отправлять файлы</h5>
                        </div>
                    </div>
                </div>
            </main>
